import { fetchOneCandidate, updateCandidateProfile, upsertCandidateProfile } from "@/services/candidates";
...
const CandidateProfileForm: React.FC<IProps> = ({ id }) => {
    ...
    const {
        ...
        ["getOneCandidate", id],
        () => id && fetchOneCandidate(Number(id)),
        {
    ...
    const handleSubmit = async (values: ICreateCandidate) => {
        ...
        if (id) {
            update({
                ...
                ...values,
                availability_start_time: values.availability_start_time ? moment(new Date(values.availability_start_time)).format("HH:mm") : "",
                availability_end_time: values.availability_end_time ? moment(new Date(values.availability_end_time)).format("HH:mm") : "",
            })
        } else {
            create({
                ...values,
    ...
    const initialData = candidateData || {
        first_name: "",
        last_name: "",
        email: "",
        free_text: "",
        ...
        <>
            ...
            >
                ...
                <Form.Item
                    ...
                    name="free_text"
                    rules={[
                        { required: true, message: "Enter Free text!" },
                    ]}
                >
                ...
                <Form.Item label="Availability Time" className="availability_time">
                    <Form.Item
                        ...
                        rules={[
                            { required: !!availabilityEndWatch, message: "Please enter start time!" },
                        ]}
                    >
                        <TimePicker
                            format="HH:mm:ss"
                    ...
                    <Form.Item
                        ...
                        rules={[
                            { required: !!availabilityStartWatch, message: "Please enter end time!" },
                        ]}
                    >
