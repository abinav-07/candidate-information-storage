...
const { loginUser } = require("../../src/controllers/auth/basicAuth")
...
describe("Auth", () => {
    ...
    expect(bcrypt.compareSync).toHaveBeenCalledWith(mockReq?.body?.password, "$2a$12$rEp6m9wsUklwdoVhrQ7gnOW1RtfbzGj/Eme2XVrfJbiwjFk/H6oMa");
